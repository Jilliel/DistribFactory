...
import fr.tp.inf112.projects.robotsim.model.persistence.distributed.RemotePersistenceManager;
import fr.tp.inf112.projects.robotsim.model.persistence.distributed.ServerPersistenceManager;
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
	        ...
	        public void run() {
				...
				// Remote manager
				//final AbstractCanvasPersistenceManager manager = new FactoryPersistenceManager(canvasChooser);
				final AbstractCanvasPersistenceManager manager = new RemotePersistenceManager(canvasChooser);
				// Init the Canvas
				//final Component viewer = new CanvasViewer(new SimulatorController(factory, manager));
				final Component viewer = new CanvasViewer(new RemoteSimulatorController(factory, manager));
